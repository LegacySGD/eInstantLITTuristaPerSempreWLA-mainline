...
public class LITTuristaPerSempreWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITTuristaPerSempreWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITNewTuristaPerSempreWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITNewTuristaPerSempreWLAIW/InitOutcome.xml").getDocumentElement();
